...
public class LifesprenLanternMenu extends AbstractContainerMenu {
    ...
    public LifesprenLanternMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 8, 81)); //redstone
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.LIFESPREN_LANTERN.get());
    }

    public int getNearbyCropsCount() {
